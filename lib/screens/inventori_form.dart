...
class InventoriFormPage extends StatefulWidget {
  const InventoriFormPage({super.key});

  @override
  State<InventoriFormPage> createState() => _InventoriFormPageState();
}
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          if (_formKey.currentState!.validate()) {
                            ...
                            Item itemproduct = Item(_name, _amount, _description);
                            Item.listitems.add(itemproduct);
                            showDialog(
                              context: context,
                              builder: (context) {
                                return AlertDialog(
